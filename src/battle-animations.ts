...
export class BattleScene implements BattleSceneStub {
	...
	getSidebarHTML(side: Side, posStr: string): string {
		...
		let custom_trainers = ['nya2314', 'sexyteddy', 'jameslyons','avgmawilefan','siobhanthegal>_<', 'oisintheguy', 'pizzawithtuna','kyletheeeveemaster', 'iskosc', 'thunados','pllayya','mixolx','gammaorionis22','shitpants87','ap0ll016'];
	...
	rollBgm() {
		//this.setBgm(16);
		this.setBgm(1 + this.getRandomInt(18));
	}
