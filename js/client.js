	...
	var UserPopup = (this.UserPopup = Popup.extend(
		{
			...
			update: function (data) {
				...
				let custom_trainers = ['nya2314', 'sexyteddy', 'jameslyons','avgmawilefan','siobhanthegal>_<', 'oisintheguy', 'thunados','kyletheeeveemaster','iskosc', 'pizzawithtuna', 'pllayya', 'mixolx','gammaorionis22','shitpants87','ap0ll016'];
